...
public class GameLogic
{
    ...
    private static bool WouldBeProtected(Board board, int sentinelX, int sentinelY, int generalX, int generalY,
    ...
    private bool IsEnemyPiece(int row, int col, string currentPlayer)
    {
    ...
    private bool IsGeneralInDangerAfterMove(int startX, int startY, int endX, int endY, string currentPlayer,
    ...
    private bool IsGeneralProtectedAfterWallConstruction(int builderX, int builderY, int wallX, int wallY, int generalX,
    ...
    /// </summary>
    /// <param name="currentPlayer">The current player's color ("white" or "black").</param>
    public static void MakeMove(string currentPlayer)
    {
    ...
    public static void WriteToNewFile(string filePath)
    {
    ...
    {
        MovePiece(startX, startY, endX, endY);
        Board.CurrentBoard = _board; // update the current board
    }
    ...
    public static void ReadFromFile(string inputBoardPath)
    {
        ...
        for (var row = 0; row < Board.Rows; row++)
        {
            ...
            for (var col = 0; col < Board.Cols; col++) Board._board[row, col] = line[col];
        }
    }
