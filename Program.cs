namespace AdvanceGame
{
    ...
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Please provide the following: Your chosen colour (either white or black) as well as the <input_board_path> and <output_board_path>");
                return;
            }
            ...
            if (args.Length == 3)
            {
                string inputBoardPath = args[1];
                string outputBoardPath = args[2];
